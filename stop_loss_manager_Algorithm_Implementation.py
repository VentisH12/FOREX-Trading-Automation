# -*- coding: utf-8 -*-
"""Copy of STOP LOSS MANAGER.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1JdpLWVBF3AQdVZyXEP2dB9KxQZSbeiWs
"""
...
def openTrades():
  client = oandapyV20.API(access_token="0615e830fff2aeed8be5999b793b7aba-d72600fed8f389fa80350499c7a10383")

  r = trades.OpenTrades(accountID="101-001-5571841-003")
  rv = client.request(r)
...
def getPrice(Tradetype):
  ...
  instruments = ["EUR_USD"]
  a = pricing.PricingStream(accountID="101-001-5571841-003", params={"instruments": ",".join(instruments)})
...
def takeProfit():
  accountID, access_token = "101-001-5571841-003", "0615e830fff2aeed8be5999b793b7aba-d72600fed8f389fa80350499c7a10383"
